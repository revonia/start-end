const htmlTags = ('a,abbr,address,area,article,aside,audio,b,base,bdi,bdo,' +
  ...
  'figcaption,figure,footer,form,header,hr,html,i,iframe,img,input,' +
  ...
  'time,title,tr,track,u,ul,var,video,wbr,h1,h2,h3,h4,h5,h6,comment').split(',')
